...
This makes TSK-powered scripts ideal for situations in Scala would be normally rejected because of the installation complexity
and set up overhead.
...
coursier_version | `v2.0.0` | version of [Coursier](https://get-coursier.io/), the workhorse for JVM and library fetching
